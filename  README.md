...
本アプリケーションは、**技術研究およびプログラミング学習**を目的として作成されています。
スクレイピングを行う際は、対象サイト（SUUMO）の**利用規約**を確認・遵守し、サーバーに過度な負荷をかけないよう、アクセス頻度等に十分ご注意ください。

* 本ツールを使用したことによる**IPアクセス制限、アカウント凍結、法的トラブル、損害**等について、開発者は一切の責任を負いません。
* データの利用およびツールの実行は、全て**利用者の自己責任**で行ってください。